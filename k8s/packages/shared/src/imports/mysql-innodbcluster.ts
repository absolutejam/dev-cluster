...
export interface MysqlinnodbclusterProps {
...
export class Mysqlinnodbcluster extends Construct {
  public constructor(scope: Construct, id: string, props: MysqlinnodbclusterProps = {}) {
    super(scope, id);
    let updatedProps = {};
